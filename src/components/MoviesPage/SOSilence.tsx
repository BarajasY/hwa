        ...
        <div className="wr_content">
            ...
            <div className="wr_second">
                ...
                <div className="wr_description">
                    <motion.p initial={{opacity: 0, y: -50}} whileInView={{opacity: 1, y:0}}>Second acceleracers movie that introduces us to new realms and new characters that come help in the mission.</motion.p>
