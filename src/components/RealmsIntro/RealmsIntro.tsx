  ...
  return (
    <div className="realmsContainer">
        <div className="realmsContent">
            <motion.div className="chargers" initial={{opacity: 0, y:-50}} whileInView={{opacity: 1, y:0}} transition={{duration:1}}>
            ...
            <motion.div className="realms" initial={{opacity: 0, y:50}} whileInView={{opacity: 1, y:0}} transition={{duration:1}}>
                <div className="circle">
                    <h1>25</h1>
                </div>
                <h1>Realms</h1>
